...
<template>
  ...
  >
    ...
    >
      ...
      <div class="max-w-0 opacity-0 overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:max-w-xs group-hover:opacity-100">
        <div class="flex flex-col items-start px-4 leading-tight whitespace-nowrap">
          <span class="text-[10px] font-bold uppercase tracking-[0.2em]" :class="userStore.isLoggedIn ? 'text-red-500' : 'text-blue-600'">
